...
class QuarkusPetclinicCloudRunJVMColdStart extends Simulation {
  ...
  val quarkusPetclinicJVM: ScenarioBuilder = scenario("Google Cloud Run - Quarkus Petclinic JVM - Cold Start Testing")
    .repeat(400, "n") {
      exec(
        OwnerAPI.getOwners
      )
