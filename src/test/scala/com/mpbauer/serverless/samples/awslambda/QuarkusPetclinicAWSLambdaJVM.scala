...
class QuarkusPetclinicAWSLambdaJVM extends Simulation {

  val httpProtocol: HttpProtocolBuilder = http
    .baseUrl("https://mgw7duxp6l.execute-api.eu-central-1.amazonaws.com")
    .inferHtmlResources()
  ...
  val quarkusPetclinicJVM: ScenarioBuilder = scenario("AWS Lambda - Quarkus Petclinic JVM")
    .feed(jsonFileFeeder)
    .repeat(500, "n") {
      exec(
